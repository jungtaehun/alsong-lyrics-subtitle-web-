...
class HomeController < ApplicationController
  ...
  def search
    ...
    al_title = params[:al_title]
    al_artist = params[:al_artist]

    res = Alsong.get_lyrics al_title, al_artist


    send_data $f,  :filename => "#{$tt}.smi"
  ...
  module Alsong
    ...
    def Alsong.get_lyrics title, artist
      ...
      xml_string = '<?xml version="1.0" encoding="UTF-8"?><SOAP-ENV:Envelope xmlns:SOAP-ENV="http://www.w3.org/2003/05/soap-envelope" xmlns:SOAP-ENC="http://www.w3.org/2003/05/soap-encoding" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns2="ALSongWebServer/Service1Soap" xmlns:ns1="ALSongWebServer" xmlns:ns3="ALSongWebServer/Service1Soap12"><SOAP-ENV:Body><ns1:GetResembleLyric2><ns1:stQuery><ns1:strTitle>'
      xml_string = xml_string + title
      xml_string = xml_string + '</ns1:strTitle><ns1:strArtistName>'
      xml_string = xml_string + artist
      xml_string = xml_string + '</ns1:strArtistName><ns1:nCurPage>0</ns1:nCurPage></ns1:stQuery></ns1:GetResembleLyric2></SOAP-ENV:Body></SOAP-ENV:Envelope>'
